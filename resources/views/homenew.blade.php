		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-md-3">
						<canvas id="ketinggian_air_bar_{{ $key }}" height="350px" width="200px;" style="margin-left: 20px;"></canvas>
					</div>
				</div>
			</div>
		</div>
		...
		function fill_chart()
		{
			$.each(_ketinggian_air, function(index, val) {
				...
				.done(function(parse) {
					...
					generate_chart_ketinggian(val['name'], index, ['Ketinggian ('+_last_ketinggian+')'], [_last_ketinggian], _last_ketinggian_word)
				})
				.fail(function() {
					console.log("error");
				})
